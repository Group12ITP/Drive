      ...
      <section className="container">
        <div className="about-intro">
          ...
          <div className="content-text">
            ...
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas id odio placerat, commodo neque quis, interdum leo. Nam hendrerit urna vitae, eget sagittis erat varius non. Duis ut varius augue. Donec tincidunt iaculis ligula, et maximus elit tincidunt eu.
            </p>
